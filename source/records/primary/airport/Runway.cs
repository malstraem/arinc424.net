...
public class Runway : Geo, IIdentity, IIcao
{
    ...
    public (float Value, CourseType Type) Bearing { get; init; }
    ...
    public float EllipsoidalHeight { get; init; }
    ...
    public int ThresholdDistance { get; init; }
    ...
    public int ThresholdHeight { get; init; }
