...
public enum PortCommUsages : uint
{
    ...
    /// </summary>
    [Map('S')] AerodromeFlightInfo = 1u << 6,
    /// <summary>
    /// Terminal Area Control (other than dedicated Terminal Control Unit).
    /// </summary>
    [Map('T')] TerminalAreaControl = 1u << 7,
    /// <summary>
    /// Aerodrome Traffic Frequency (ATF).
    /// </summary>
    [Offset, Map('A')] AerodromeTraffic = 1u << 8,
    /// <summary>
    /// Common Traffic Advisory Frequency (CTAF).
    /// </summary>
    [Map('C')] CommonTraffic = 1u << 9,
    /// <summary>
    /// Mandatory Frequency (MF).
    /// </summary>
    [Map('M')] Mandatory = 1u << 10,
    /// <summary>
    /// Air/Air.
    /// </summary>
    [Map('R')] AirToAir = 1u << 11,
    /// <summary>
    /// Secondary Frequency.
    /// </summary>
    [Map('S')] Secondary = 1u << 12,
    /// <summary>
    /// Air/Ground.
    /// </summary>
    [Offset, Map('A')] AirGround = 1u << 13,
    /// <summary>
    /// VHF Direction Finding Service (VDF).
    /// </summary>
    [Map('D')] DirectionFinding = 1u << 14,
    /// <summary>
    /// Remote Communications Air to Ground (RCAG).
    /// </summary>
    [Map('G')] RemoteAirToGround = 1u << 15,
    /// <summary>
    /// Language other than English.
    /// </summary>
    [Map('L')] NotEnglish = 1u << 16,
    /// <summary>
    /// Military Use Frequency.
    /// </summary>
    [Map('M')] Military = 1u << 17,
    /// <summary>
    /// Pilot Controlled Light (PCL).
    /// </summary>
    [Map('P')] ControlledLight = 1u << 18,
    /// <summary>
    /// Remote Communications Outlet (RCO).
    /// </summary>
    [Map('R')] RemoteOutlet = 1u << 19
}
