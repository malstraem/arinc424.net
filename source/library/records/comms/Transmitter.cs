...
public abstract class Transmitter : Geo, ISequenced
{
    ...
    [Character<Transmitter>(41, Start = Supplement.V19)]
    ...
    [Character<Transmitter>(42, Start = Supplement.V19)]
    public Bool IsWholeDay { get; set; }

    /// <summary><c>Call Sign (CALL SIGN)</c> field.</summary>
    /// <remarks>See section 5.105.</remarks>
    [Field<PortTransmitter>(99, 123)]
    [Field<Transmitter>(43, 67, Start = Supplement.V19)]
    public string? CallSign { get; set; }

    /// <inheritdoc cref="Arinc424.AltitudeDescription"/>
    [Character(69), Character(83, Start = Supplement.V19)]
    [Character<AirwayTransmitter>(93)]
    [Character<AirwayTransmitter>(117, Start = Supplement.V19)]
    ...
    [Field<AirwayTransmitter>(118, 120, Start = Supplement.V19)]
    [Decode<CommAltitudeConverter, Altitude>(Start = Supplement.V19)]
    public Altitude Altitude { get; set; }

    /// <inheritdoc cref="Altitude"/>
    [Field(75, 79), Field(87, 89, Start = Supplement.V19)]
    [Field<AirwayTransmitter>(99, 103)]
    [Field<AirwayTransmitter>(121, 123, Start = Supplement.V19)]
    [Decode<CommAltitudeConverter, Altitude>(Start = Supplement.V19)]
