...
internal sealed class CommWrapBeforeV19<TComm, TTransmitter>(Supplement supplement) 
    : Wrap<TComm, TTransmitter>(supplement)
        ...
        where TTransmitter : Transmitter
{
    ...
    protected override bool Trigger(TTransmitter current, TTransmitter next)
